...
function OverallSlide2() {
  ...
  return (
    <div id="overall-slide-2" className="w-[1280px] h-[720px]">
      <div className="flex flex-col w-full h-full bg-white border">
        {/* Header */}
        <div className="px-8 py-4 border-b">
          <SlideHeader title={"Overall 2"} />
        </div>

        {/* Content Area */}
        <div className="flex-1 p-6 grid grid-cols-2 gap-6">
          {/* Posts by Source */}
          <div className="bg-gray-50 p-4 rounded-lg border col-span-2 h-fit px-6">
          ...
          <div className="bg-gray-50 p-4 rounded-lg border h-fit">
            <HorizontalStackedBar
              data={chartData.overallSentiment}
              title="Overall Sentiment"
            />
          </div>
          {/* Quick Stats */}
          <div className="bg-blue-50 p-4 rounded-lg border h-fit">
