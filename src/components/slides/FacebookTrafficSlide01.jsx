...
function FacebookTrafficSlide01() {
  const {
    loading,
    error,
    refetch,
  ...
  const summarizeData = useCallback(() => {
    ...
    try {
      // Handle "No Data" case
      if (
        FacebookTrafficAudienceTotals[KEY] === "No Data" ||
        !FacebookTrafficAudienceTotals ||
        Object.keys(FacebookTrafficAudienceTotals).length === 0
      ) {
      ...
      let summaryTextTemp = "";
      const averageCPC = FacebookTrafficAudienceTotals.cpc?.toLocaleString(
        undefined,
        {
      ...
      const overallText = `Overall Clicks: ** ${parseFloat(
        FacebookTrafficAudienceTotals[KEY]?.toFixed(2) || 0
      ...
      const topAudience = FacebookTrafficAudienceData
        ? Object.entries(FacebookTrafficAudienceData).reduce(
            (max, [key, value]) =>
      ...
      const topCreative = FacebookTrafficAudienceData
        ? Object.entries(FacebookTrafficAudienceData).reduce(
            (max, [key, value]) =>
      ...
      const totalConversions = FacebookTrafficAudienceTotals?.Conversions;
  ...
  }, [FacebookTrafficAudienceTotals, FacebookTrafficAudienceData]);
  ...
  return (
    <div
      id="facebook-traffic-01-component"
    ...
    >
      ...
      <SlideHeader title={"Facebook Traffic (1/2)"} />
          ...
          <div className="col-span-12 flex flex-col gap-2">
            ...
            <div>
              ...
              <AdvancedDataTable
                ...
                channelData={FacebookTrafficAudienceData}
...
export default FacebookTrafficSlide01;
