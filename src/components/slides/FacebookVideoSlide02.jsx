...
function FacebookVideoSlide02() {
  ...
  const summarizeData = useCallback(() => {
    ...
    try {
      // Handle "No Data" case
      if (
        FacebookVideoCreativeTotals[KEY] === "No Data" ||
        !FacebookVideoCreativeTotals ||
        Object.keys(FacebookVideoCreativeTotals).length === 0
      ) {
      ...
      let summaryTextTemp = "";
      const averageCPV = FacebookVideoCreativeTotals.cpv?.toLocaleString(
        undefined,
        {
      ...
      const overallText = `Overall Video View: ** ${parseFloat(
        FacebookVideoCreativeTotals[KEY]?.toFixed(2) || 0
      ...
      const topAudience = FacebookVideoCreativeData
        ? Object.entries(FacebookVideoCreativeData).reduce(
            (max, [key, value]) =>
      ...
      const topCreative = FacebookVideoCreativeData
        ? Object.entries(FacebookVideoCreativeData).reduce(
            (max, [key, value]) =>
      ...
      const totalConversions = FacebookVideoCreativeTotals?.Conversions;
  ...
  }, [FacebookVideoCreativeTotals, FacebookVideoCreativeData]);
  ...
  return (
    <div
      id="facebook-video-02-component"
    ...
    >
      ...
      <SlideHeader title={"Facebook VDO View (2/2)"} />
        ...
        <div className="grid grid-cols-16">
          <div className="col-span-12 flex flex-col gap-2">
            ...
            <div>
              ...
              <AdvancedDataTable
                firstMetric="Ad name"
                channelData={FacebookVideoCreativeData}
                totalData={FacebookVideoCreativeTotals}
                metrics={[
                  "Ad name",
                  "impressions",
                  "reach",
...
export default FacebookVideoSlide02;
