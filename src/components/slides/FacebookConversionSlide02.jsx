...
function FacebookConversionSlide02() {
  const {
    loading,
    error,
    refetch,
  ...
  return (
    ...
    >
      ...
      <SlideHeader title={"Facebook Conversion (2/2)"} />
        ...
        <div className="grid grid-cols-16">
          <div className="col-span-12 flex flex-col gap-2">
            ...
            <div>
              ...
              <AdvancedDataTable
                firstMetric="Ad name"
                channelData={FacebookConversionCreativeData}
                totalData={FacebookConversionCreativeTotals}
                metrics={[
                  "Ad name",
                  "impressions",
                  "reach",
...
export default FacebookConversionSlide02;
